...
public class InputValidator {
    ...
    public void validatePurchaseProducts(final String products) {
        if (!PURCHASE_PRODUCTS_FORMAT.matcher(products).matches()) {
            throw new IllegalArgumentException(ErrorMessage.INVALID_FORMAT.getMessage());
        }
    }

    public void validatePurchaseProductDTOs(final List<PurchaseProductDTO> purchaseProductDTOs) {
    ...
    private void validateDuplicationPurchaseProductDTOs(final List<PurchaseProductDTO> purchaseProductDTOs) {
    ...
    private void validatePurchaseQuantityLessThanMin(final PurchaseProductDTO purchaseProductDTO) {
        if (purchaseProductDTO.getQuantity() <= PURCHASE_QUANTITY_MIN) {
            throw new IllegalArgumentException(ErrorMessage.INVALID_FORMAT.getMessage());
        }
    }

    public void validateAnswer(final String answer) {
